...
#include "myiic.h"
//myiic.h主要调用了放在里面的delay_us函数，本驱动不包含
...
void AD9854_WR_Byte(uint32_t addr,uint32_t dat)
{
	dat1= dat|(addr<<8);
    uint32_t x;
    x=(dat1&0x3fff)|((dat1^0x3fff)<<16);
    HAL_GPIO_WritePin(D0_GPIO_Port,D0_Pin,x&0x1);
    HAL_GPIO_WritePin(D1_GPIO_Port,D1_Pin,x>>1&0x1);
    HAL_GPIO_WritePin(D2_GPIO_Port,D2_Pin,x>>2&0x1);
    HAL_GPIO_WritePin(D3_GPIO_Port,D3_Pin,x>>3&0x1);
    HAL_GPIO_WritePin(D4_GPIO_Port,D4_Pin,x>>4&0x1);
    HAL_GPIO_WritePin(D5_GPIO_Port,D5_Pin,x>>5&0x1);
    HAL_GPIO_WritePin(D6_GPIO_Port,D6_Pin,x>>6&0x1);
    HAL_GPIO_WritePin(D7_GPIO_Port,D7_Pin,x>>7&0x1);
    HAL_GPIO_WritePin(A0_GPIO_Port,A0_Pin,x>>8&0x1);
    HAL_GPIO_WritePin(A1_GPIO_Port,A1_Pin,x>>9&0x1);
    HAL_GPIO_WritePin(A2_GPIO_Port,A2_Pin,x>>10&0x1);
    HAL_GPIO_WritePin(A3_GPIO_Port,A3_Pin,x>>11&0x1);
    HAL_GPIO_WritePin(A4_GPIO_Port,A4_Pin,x>>12&0x1);
    HAL_GPIO_WritePin(A5_GPIO_Port,A5_Pin,x>>13&0x1);
...
{
	// HAL_GPIO_WritePin(WD_GPIO_Port,WD_Pin,GPIO_PIN_SET);//将读、写控制端口设为无效
    // HAL_GPIO_WritePin(RD_GPIO_Port,RD_Pin,GPIO_PIN_SET);
    // HAL_GPIO_WritePin(UCLK_GPIO_Port,UCLK_Pin,GPIO_PIN_SET);
    // HAL_GPIO_WritePin(RST_GPIO_Port,RST_Pin,GPIO_PIN_SET);                 //复位AD9854
    // HAL_GPIO_WritePin(RST_GPIO_Port,RST_Pin,GPIO_PIN_RESET);

    HAL_GPIO_WritePin(WD_GPIO_Port,WD_Pin,GPIO_PIN_SET);
    HAL_GPIO_WritePin(RD_GPIO_Port,RD_Pin,GPIO_PIN_SET);
    HAL_GPIO_WritePin(UCLK_GPIO_Port,UCLK_Pin,GPIO_PIN_RESET);
   ...
   // delay_us(10);
	...
	// HAL_GPIO_WritePin(UCLK_GPIO_Port,UCLK_Pin,GPIO_PIN_RESET);               //更新AD9854输出
    // HAL_GPIO_WritePin(UCLK_GPIO_Port,UCLK_Pin,GPIO_PIN_SET);
